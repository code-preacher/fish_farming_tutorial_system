         ...
         <ul id="slide-out" class="side-nav fixed">
           <div class="card">
              ...
              <div class="card-reveal">
                ...
                <h6><label>Department:</label><br> <?php echo $university ?></h6>
                ...
                <a href="logout.php" style="color:teal;text-align:center;">Logout</a> 
              </div>
            </div>
         </ul>
...
<div class="container white z-depth-2" id="test12">
  ...
  <ul class="tabs teal homeTab">
    <li class="tab col s3"><a class="white-text active orange" href="#watchvid">Watch videos</a></li>
          <li class="tab col s3"><a class="white-text active orange" href="#readbook">Read book</a></li> 
    <li class="tab col s3"><a class="white-text orange" href="#downloadvid">Download videos</a></li>
    <li class="tab col s3"><a class="white-text orange" href="#downloadbook">Download book</a></li>
      </ul>
  ...
  <div id="downloadvid" class="col s12">
    <?php include 'downloadvid.php'; ?>
  </div>
  ...
  <div id="downloadbook" class="col s12">
    <?php include 'downloadbook.php'; ?>
  </div>
